...
{
    class SemanticZoomUiElement : AutomationElement, IUiElement
    {
        ...
        public SemanticZoomUiElement(FrameworkAutomationElementBase frameworkAutomationElement) : base(frameworkAutomationElement)
        {
        }
    }
}
