...
{
    class HeaderUiElement : AutomationElement, IUiElement
    {
        ...
        public HeaderUiElement(FrameworkAutomationElementBase frameworkAutomationElement) : base(frameworkAutomationElement)
        {
        }
    }
}
