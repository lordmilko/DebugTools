EXTERN EnterStubWithInfo:PROC
EXTERN LeaveStubWithInfo:PROC
EXTERN TailcallStubWithInfo:PROC
...
ALIGN 16
PUBLIC EnterNakedWithInfo

EnterNakedWithInfo PROC FRAME
...
EnterNakedWithInfo ENDP

ALIGN 16
PUBLIC LeaveNakedWithInfo

LeaveNakedWithInfo PROC FRAME
...
LeaveNakedWithInfo ENDP

ALIGN 16
PUBLIC TailcallNakedWithInfo

TailcallNakedWithInfo PROC FRAME
