...
#ifdef _X86_
void __declspec(naked) TailcallNakedWithInfo(FunctionIDOrClientID functionIDOrClientID, COR_PRF_ELT_INFO eltInfo)
{
    __asm
    {
...
NoSaveFPReg:
    ...
    TailcallStubWithInfo(functionIDOrClientID, eltInfo);
...
EXTERN_C void TailcallNakedWithInfo(FunctionIDOrClientID functionIDOrClientID, COR_PRF_ELT_INFO eltInfo);
#endif
