...
{
    ENTER_FUNCTION(functionId.functionID, FrameKind::Managed);

    LogCall(L"Enter", functionId);
...
#ifdef _X86_
void __declspec(naked) EnterNaked(FunctionIDOrClientID functionIDOrClientID)
{
    __asm
    {
...
NoSaveFPReg:
    ...
    EnterStub(functionIDOrClientID);
